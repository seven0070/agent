...
export const SystemPanel: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      {health ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ padding: '8px 12px', background: '#0f172a', borderRadius: '6px', fontSize: '12px', color: '#cbd5e1' }}>
            Desktop Runtime Endpoint: <strong style={{ color: '#38bdf8' }}>http://127.0.0.1:8000</strong> | Version: <strong style={{ color: '#10b981' }}>{health.version || '0.1.0'}</strong>
          </div>
